...
const {createCheckIn, createCheckOut, getWorkedTime, getAllWorkedTime, getActualTimeOfWork, getLastWorkedTIme} = require("../controllers/fichajesControllers")
...
router.get("/lastWorkedTime", isAuth, getLastWorkedTIme)
